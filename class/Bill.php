...
class bill{
    ...
    function ReadAll(){
        try {
            $sql='SELECT c.id, cl.name, c.billing_day, c.number, c.frequencyPay, c.priceMonitoring, c.methodPayment
            FROM contracts c
