...
if(isset($_POST["action"])){
    ...
    switch($opt){
        case "ReadAll":
            echo json_encode($invoice->ReadAll());
            break;
        case "Create":
            $invoice->Create();
            break;
...
class invoice{
    ...
    function ReadAll(){
        try {
            ...
            header('HTTP/1.0 400 Load Contracts Bad error');
