...
$invoice = new InvoicePrinter();
  ...
  $invoice->addItem("Subscripción Servicio Monitoreo","Mensual",1,0,10221,0,10221);
...
//   $invoice->Output('example1.pdf', 'I'); //Con esta funcion imprime el archivo en otra ubicacion
